        ...
        <>
            <HeroSection>
                <HeroContainer className="svg-animate-img">
                    <Typography className="max-w-7xl text-[32px] md:text-[64px] text-center font-bold" fontFamily="Jura" variant="h1" gradient="yes" content="An Asset Tokenization Platform For Regenerative Finance." />
                    <HeroAnimationSVG />
            ...
            <EcoSystemSection>
                ...
                <EcoSystemContainer className="flex-col md:flex-row">
                    <EcoSystemBox>
                        ...
                        <Typography variant="h5" className="leading-relaxed mt-12" fontFamily="Jura" content="∙ Early access to Refi projects" />
            ...
            <AssetsSection>
                <AssetsContainer className="flex-col md:flex-row">
                    <AssetsCol>
                        <Typography variant="h1" className="dark:text-[#D9D9D9] text-[32px] md:text-[64px] text-primary tracking-[5px] dark:text-opacity-80 leading-[1.5] font-semibold mb-10" fontFamily="Poppins" content="Start making an IMPACT, invest in ECORISE assets" />
                        <Button className="inline-block min-w-[244px] min-h-[60px] mb-10 md:mb-0" variant="gradient" size="lg" rounded="xl" fontFamily="Poppins" value="Join Us" />
                    </AssetsCol>
                    <AssetsImages>
                        <Image
                            src={'/asset-new-1.png'}
            ...
            <IncomeSection>
                <IncomeContainer className="flex-col md:flex-row">
                    ...
                    />
                    <IncomeCol>
                        <Typography variant="h1" className="break-words dark:text-[#D9D9D9] dark:text-opacity-80 text-[32px] md:text-[64px] leading-relaxed font-semibold mb-10 leading-tight md:tracking-[5px]" fontFamily="Poppins" content="Automatically receive income" />
            ...
            <ProjectSection>
                ...
                <div className="flex items-center mx-auto md:w-1/2">
                    <input
                        ...
                        className={`${styles.inputdashboard} rounded-l-lg`} placeholder='Enter your Email...'
                    />
